  ...
  for i, _20_ in ipairs(match_positions) do
    ...
    if not (skip_curpos_3f and (line == curline) and (col == curcol)) then
      ...
      elseif (nil ~= _22_) then
        ...
        xxx_3f = ((line == prev_match.line) and _24_() and (__3erepresentative_char(ch2) == __3erepresentative_char((prev_match.ch2 or ""))))
...
local function get_targets(pattern, _45_)
  ...
  local match_xxx_2a_at_the_end_3f = _arg_46_["match-xxx*-at-the-end?"]
  ...
  do
    local _47_ = target_windows0
    if ((_G.type(_47_) == "table") and ((_47_)[1] == source_winid) and ((_47_)[2] == nil)) then
